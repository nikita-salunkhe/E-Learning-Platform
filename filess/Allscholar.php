...
$query=$con->prepare("SELECT * FROM `scholarship` WHERE `Flag`=1");
$query->execute();
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-sm-5 col-md-5 col-xs-5 col-lg-5">
                ...
                <b><p class="card-text">Description : <b><?php echo $res['scholarship_description']; ?></b><br></p>
                <p class="card-text">Condition for Applying : <b><?php echo $res['condition_for_applying']; ?></b><br></p>
