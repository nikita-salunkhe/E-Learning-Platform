...
$query=$con->prepare("SELECT * FROM `scholarship`");
$query->execute();
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav" class="p-t-30">
                          ...
                          <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="Allcourses.php" aria-expanded="false"><i class="mdi  mdi-book-open"></i><span class="hide-menu">Courses</span></a></li>
                            ...
                            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="Alljobs.php" aria-expanded="false"><i class="mdi mdi-laptop"></i><span class="hide-menu">Job Portal</span></a></li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h2 class="page-title">Scholarship</h2>
                    </div>
                </div>
                <br>
            </div>
    ...
    while($res=$run->fetch_assoc())
    {
         ...
         if(com==0)
         {
            ...
            <div class="card card-hover">
                <div class="box bg-cyan "style="height: 12rem;">

                    <h3 class="text-white"><?php echo $res['Name'] ?></h3>
                    ...
                    <div class="footer">
                        ...
                        <b><?php echo $res['description'] ?></b><br>
                        Income Limit: <b><?php echo $res['income_limit'] ?></b><br>
                        
                        </div>
                        <div class="col-md-4 col-lg-4 col-xlg-4">
                        Applicable For : <b><?php echo $res['applicable_for'] ?></b><br>
                        Reward Amount : <b><?php echo $res['Reward_Amount'] ?></b><br>
                        Contact : <b><?php echo $res['Contact_Details'] ?></b><br>
                    </div>
                    <div class="col-md-4 col-lg-4 col-xlg-4">
                        <br>
                        
                    <a type="button" class="btn btn-info btn" href ="Mycourses.html">Apply</a>
                    </div>
                    </div>
                    </p>
         ...
         else if(State==null)
         {
             ...
             tab += `<div class="row">
                ...
                <div class="col-md-10 col-lg-10 col-xlg-10">
            <div class="card card-hover">
                <div class="box"style="height: 12rem; background-color:#4e5178;">
