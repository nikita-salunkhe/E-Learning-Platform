            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" aria-expanded="false"><i class="mdi mdi-school"></i><span class="hide-menu">Uploaded Scholarships</span></a></li>
        ...
        <div class="page-wrapper">
            <div class="page-breadcrumb">
                ...
                <div class="card-body" style =" background-color: white">
                    <center>  <h4 >Scholarship Request </h4></center>
                </div>
              </div>
            </div>
            <div class="col-sm-4 col-md-4 col-xs-4 col-lg-4"></div>
