 ...
 while($res=$run->fetch_assoc())
 {
      ...
      if(City==="All")
      {
         ...
         tab += `       <div class="card boxx" style=" background-color:  Azure">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-5 col-md-5 col-xs-5 col-lg-5">
                        ...
                        <b><p class="card-text">Description : <b><?php echo $res['Course_Description']; ?></b><br></p>
                        ...
                        Link for more details : <b><?php echo '<a href= ' .$res['course_link'].'>' .$res['course_link'].' </a>' ;?></b></b><br>
                 ...
                 <div class="col-sm-3 col-md-3 col-xs-3 col-lg-3">
                 <br>
               <a href="course_enroll.php?enrolled=<?php echo $res['id']; ?>" class="btn btn-primary btn-lg">Enroll</a>
