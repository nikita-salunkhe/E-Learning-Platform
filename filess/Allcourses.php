...
<div class="card card-hover">
    <div class="box bg-cyan "style="height: 13rem;">
        ...
        <h3 class="text-white"><?php echo $res['course_name'] ?></h3>
        ...
        <div class="footer">
            ...
            <b><?php echo $res['Course_Description'] ?></b><br>
            Income : <b><?php echo $res['course_duration'] ?></b><br>
            <b><?php echo $res['course_fees'] ?></b><br>

            </div>
            <div class="col-md-4 col-lg-4 col-xlg-4">
            Apply Date : <b><?php echo $res['course_duration'] ?></b><br>

            Who Can Apply : <b><?php echo $res['applicable_for'] ?></b><br>
        </div>
        <div class="col-md-4 col-lg-4 col-xlg-4">
            <br>
